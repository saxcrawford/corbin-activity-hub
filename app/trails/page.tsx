...
import Navbar from "../components/navbar"; // Assuming Navbar is the optimized version
import Link from "next/link";
import Image from "next/image";
import cumberlandFalls from "../images/cumberlandFalls.jpeg";
import { getTrails } from "../lib/data/trails"; // Assuming this returns an array of { title: string, description: string }
...
const TrailsCard = ({
    ...
    return (
        <div
            ...
            tabIndex={0} // Make the card focusable for tap interaction and keyboard navigation
        >
            <div
...
const Attribution = () => (
    // Spans all columns, appears at the top of the grid
    <div className="col-span-full rounded-lg text-white bg-black/50 px-3 py-1.5 text-xs sm:text-sm mb-2 sm:mb-0">
...
function Trails() {
    ...
    return (
        <div className="bg-background min-h-screen text-corbinBlue">
            ...
            <main className="px-4 sm:px-6 lg:px-8 pb-8 sm:py-12">
                {/* Hero Text Section */}
                ...
                {/* Trails Grid Section with Background Image */}
                <section
                ...
                >
                    ...
                    <div className="absolute inset-0 z-0">
                        <Image
                            ...
                            quality={85}
                            placeholder="blur" // Good to have if cumberlandFalls has a blurDataURL
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-black/10"></div> {/* Darker overlay at bottom */}
                    </div>

                    {/* Grid for Cards and Attribution */}
                    <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-5 md:gap-6 p-4 sm:p-5 md:p-6">
                        ...
                        {trailInfo.map((trail, index) => (
                            <TrailsCard
                                key={index} // Consider using a unique ID from trail data if available
                                title={trail.title}
                ...
                {/* "See More Trails" Button Section */}
